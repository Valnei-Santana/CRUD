...
acao = {
    ...
    fim: function(id) {
        $.ajax({
            ...
            success: function(data) {
                if (data.state == 'true') {
                    getAtividade(0, 'atvd-list'); //Carrego novamente a lista atualizada
                    getAtividade(5, 'fechadas-list'); //Carrego novamente a lista atualizada
                    $(function() {
                        Toast.fire({
                            icon: 'success',
                            title: data.message
